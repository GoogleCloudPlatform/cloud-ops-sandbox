module github.com/GoogleCloudPlatform/cloud-ops-sandbox/src/shippingservice
...
require (
	...
	github.com/GoogleCloudPlatform/microservices-demo/src/shippingservice v0.0.0-20210219170230-3a1850d65f8c
