...
function LogUsage {
  ...
  Log ""
  Log "options:"
  Log "-p <id>|--project <id>  ID of the GCP project to host Sandbox."
  Log "-app <id>|--app-id <id>  An application id that identifies the Sandbox configuration."
  Log "--billing_acc <id>       A billing account to use with 'create-all' command to new created GCP project."
